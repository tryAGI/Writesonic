...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_PassiveToActiveVoiceSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_PassiveToActiveVoiceSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_PassiveToActiveVoiceSecurityRequirement0,
            };
        partial void PreparePassiveToActiveVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Writesonic.PassiveToActiveVoiceEngine engine,
            ref global::Writesonic.PassiveToActiveVoiceLanguage language,
            ref int numCopies,
            global::Writesonic.ActiveVoiceRequest request);
        partial void PreparePassiveToActiveVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int numCopies,
            global::Writesonic.ActiveVoiceRequest request);
        partial void ProcessPassiveToActiveVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPassiveToActiveVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> PassiveToActiveVoiceAsync(
            global::Writesonic.PassiveToActiveVoiceEngine engine,
            global::Writesonic.PassiveToActiveVoiceLanguage language,
            int numCopies,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> PassiveToActiveVoiceAsResponseAsync(
            global::Writesonic.PassiveToActiveVoiceEngine engine,
            global::Writesonic.PassiveToActiveVoiceLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePassiveToActiveVoiceArguments(
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PassiveToActiveVoiceSecurityRequirements,
                operationName: "PassiveToActiveVoiceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePassiveToActiveVoiceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PassiveToActiveVoice",
                                methodName: "PassiveToActiveVoiceAsync",
                                pathTemplate: "\"/v2/business/content/active-voice\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPassiveToActiveVoiceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPassiveToActiveVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PassiveToActiveVoiceAsync(
                engine: engine,
                language: language,
                numCopies: numCopies,
                request: __request,
