...
namespace Writesonic
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Writesonic.AutoSDKRetryOptions Retry { get; set; } = new global::Writesonic.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Writesonic.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Writesonic.IAutoSDKHook>();
        ...
        public global::Writesonic.AutoSDKClientOptions AddHook(
            global::Writesonic.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Writesonic.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Writesonic.AutoSDKClientOptions UseAuthorizationProvider(
            global::Writesonic.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Writesonic.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Writesonic.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Writesonic.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Writesonic.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Writesonic.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Writesonic.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Writesonic.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Writesonic.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Writesonic.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Writesonic.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Writesonic.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Writesonic.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Writesonic.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Writesonic.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Writesonic.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Writesonic.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Writesonic.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Writesonic.IAutoSDKHook, global::Writesonic.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Writesonic.AutoSDKHookContext context)
        {
