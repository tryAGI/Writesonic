...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_AmazonProductDescriptionsSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_AmazonProductDescriptionsSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_AmazonProductDescriptionsSecurityRequirement0,
            };
        partial void PrepareAmazonProductDescriptionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Writesonic.AmazonProductDescriptionsEngine engine,
            ref global::Writesonic.AmazonProductDescriptionsLanguage language,
            ref int numCopies,
            global::Writesonic.AmazonProductDescriptionsRequest request);
        partial void PrepareAmazonProductDescriptionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int numCopies,
            global::Writesonic.AmazonProductDescriptionsRequest request);
        partial void ProcessAmazonProductDescriptionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAmazonProductDescriptionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> AmazonProductDescriptionsAsync(
            global::Writesonic.AmazonProductDescriptionsEngine engine,
            global::Writesonic.AmazonProductDescriptionsLanguage language,
            int numCopies,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> AmazonProductDescriptionsAsResponseAsync(
            global::Writesonic.AmazonProductDescriptionsEngine engine,
            global::Writesonic.AmazonProductDescriptionsLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAmazonProductDescriptionsArguments(
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AmazonProductDescriptionsSecurityRequirements,
                operationName: "AmazonProductDescriptionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAmazonProductDescriptionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AmazonProductDescriptions",
                                methodName: "AmazonProductDescriptionsAsync",
                                pathTemplate: "\"/v2/business/content/amazon-product-descriptions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAmazonProductDescriptionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAmazonProductDescriptionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AmazonProductDescriptionsAsync(
                engine: engine,
                language: language,
                numCopies: numCopies,
                request: __request,
