...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_EmailSubjectLinesSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_EmailSubjectLinesSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_EmailSubjectLinesSecurityRequirement0,
            };
        partial void PrepareEmailSubjectLinesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Writesonic.EmailSubjectLinesEngine engine,
            ref global::Writesonic.EmailSubjectLinesLanguage language,
            ref int numCopies,
            global::Writesonic.SubjectLinesRequest request);
        partial void PrepareEmailSubjectLinesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int numCopies,
            global::Writesonic.SubjectLinesRequest request);
        partial void ProcessEmailSubjectLinesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEmailSubjectLinesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> EmailSubjectLinesAsync(
            global::Writesonic.EmailSubjectLinesEngine engine,
            global::Writesonic.EmailSubjectLinesLanguage language,
            int numCopies,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> EmailSubjectLinesAsResponseAsync(
            global::Writesonic.EmailSubjectLinesEngine engine,
            global::Writesonic.EmailSubjectLinesLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEmailSubjectLinesArguments(
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EmailSubjectLinesSecurityRequirements,
                operationName: "EmailSubjectLinesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEmailSubjectLinesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EmailSubjectLines",
                                methodName: "EmailSubjectLinesAsync",
                                pathTemplate: "\"/v2/business/content/subject-lines\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEmailSubjectLinesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEmailSubjectLinesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await EmailSubjectLinesAsync(
                engine: engine,
                language: language,
                numCopies: numCopies,
                request: __request,
