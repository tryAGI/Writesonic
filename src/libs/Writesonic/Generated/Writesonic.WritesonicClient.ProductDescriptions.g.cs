...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_ProductDescriptionsSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_ProductDescriptionsSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_ProductDescriptionsSecurityRequirement0,
            };
        partial void PrepareProductDescriptionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Writesonic.ProductDescriptionsEngine engine,
            ref global::Writesonic.ProductDescriptionsLanguage language,
            ref int numCopies,
            global::Writesonic.ProductDescriptionsRequest request);
        partial void PrepareProductDescriptionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int numCopies,
            global::Writesonic.ProductDescriptionsRequest request);
        partial void ProcessProductDescriptionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProductDescriptionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> ProductDescriptionsAsync(
            global::Writesonic.ProductDescriptionsEngine engine,
            global::Writesonic.ProductDescriptionsLanguage language,
            int numCopies,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> ProductDescriptionsAsResponseAsync(
            global::Writesonic.ProductDescriptionsEngine engine,
            global::Writesonic.ProductDescriptionsLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProductDescriptionsArguments(
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProductDescriptionsSecurityRequirements,
                operationName: "ProductDescriptionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProductDescriptionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProductDescriptions",
                                methodName: "ProductDescriptionsAsync",
                                pathTemplate: "\"/v2/business/content/product-descriptions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProductDescriptionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProductDescriptionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> ProductDescriptionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Writesonic.ProductDescriptionsRequest
            {
                ProductName = productName,
                ProductCharacteristics = productCharacteristics,
            };

            return await ProductDescriptionsAsync(
                engine: engine,
                language: language,
                numCopies: numCopies,
                request: __request,
