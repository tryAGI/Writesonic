...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_ContentRephraseSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_ContentRephraseSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_ContentRephraseSecurityRequirement0,
            };
        partial void PrepareContentRephraseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Writesonic.ContentRephraseEngine engine,
            ref global::Writesonic.ContentRephraseLanguage language,
            ref int numCopies,
            global::Writesonic.ContentRephraseRequest request);
        partial void PrepareContentRephraseRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int numCopies,
            global::Writesonic.ContentRephraseRequest request);
        partial void ProcessContentRephraseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessContentRephraseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>> ContentRephraseAsync(
            global::Writesonic.ContentRephraseEngine engine,
            global::Writesonic.ContentRephraseLanguage language,
            int numCopies,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> ContentRephraseAsResponseAsync(
            global::Writesonic.ContentRephraseEngine engine,
            global::Writesonic.ContentRephraseLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareContentRephraseArguments(
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ContentRephraseSecurityRequirements,
                operationName: "ContentRephraseAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ContentRephrase",
                                methodName: "ContentRephraseAsync",
                                pathTemplate: "\"/v2/business/content/content-rephrase\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessContentRephraseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessContentRephraseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ContentRephraseAsync(
                engine: engine,
                language: language,
                numCopies: numCopies,
                request: __request,
