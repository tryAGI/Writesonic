...
namespace Writesonic
{
    public partial class WritesonicClient
    {
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement s_QuestionGenerationSecurityRequirement0 =
        ...
        private static readonly global::Writesonic.EndPointSecurityRequirement[] s_QuestionGenerationSecurityRequirements =
            new global::Writesonic.EndPointSecurityRequirement[]
            {                s_QuestionGenerationSecurityRequirement0,
            };
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Writesonic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Writesonic.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Writesonic.ContentOutput>>> QuestionGenerationAsResponseAsync(
            global::Writesonic.QuestionGenerationEngine engine,
            global::Writesonic.QuestionGenerationLanguage language,
            int numCopies,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Writesonic.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QuestionGenerationSecurityRequirements,
                operationName: "QuestionGenerationAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Writesonic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Writesonic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QuestionGenerationAsync",
                                pathTemplate: "\"/v2/business/content/question-generation\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
